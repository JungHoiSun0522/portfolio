...
|:---:|:---:|:---:|:---:|:---:|
| ![기본 화면](test_img/기본.jpg) | ![내부 IP로 접속한 클라이언트](test_img/내부IP.gif) | ![외부 IP로 접속한 클라이언트](test_img/외부IP.gif) | ![강제 서버 종료](test_img/강제%20종료.JPG) | ![서버 정상 종료](test_img/정상%20종료.JPG) |
