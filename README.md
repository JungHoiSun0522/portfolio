...
- **링크**: [스마트 TV 생산 라인 자동화 솔루션](https://github.com/JungHoiSun0522/portfolio/tree/1st_pjt)
...
### 4. **VR HMD를 활용한 비정상비행 승무원 교육훈련 콘텐츠**
>MFC와 WPF를 활용하여 TCP/IP기반 멀티 유저 채팅 프로그램입니다.
